...
# On G2:
sbatch --gres=gpu:3090:1 --partition=kilian -t 1-00:00:00 --mail-user=$2 eval/zeroshot_S.sh $1
sbatch --gres=gpu:3090:1 --partition=kilian -t 1-00:00:00 --mail-user=$2 eval/fewshot_S.sh $1
sbatch --gres=gpu:3090:1 --partition=kilian -t 1-00:00:00 --mail-user=$2 eval/cot_S.sh $1
# sbatch --gres=gpu:3090:1 --partition=kilian -t 1-00:00:00 --mail-user=$2 eval/zeroshot-sc_S.sh $1
# sbatch --gres=gpu:3090:1 --partition=kilian -t 1-00:00:00 --mail-user=$2 eval/fewshot-sc_S.sh $1
# sbatch --gres=gpu:3090:1 --partition=kilian -t 1-00:00:00 --mail-user=$2 eval/cot-sc_S.sh $1

sbatch --gres=gpu:a6000:1 --partition=kilian -t 1-00:00:00 --mail-user=$2 eval/zeroshot_M.sh $1
sbatch --gres=gpu:a6000:1 --partition=kilian -t 1-00:00:00 --mail-user=$2 eval/fewshot_M.sh $1
sbatch --gres=gpu:a6000:1 --partition=kilian -t 1-00:00:00 --mail-user=$2 eval/cot_M.sh $1
# sbatch --gres=gpu:a6000:1 --partition=kilian -t 1-00:00:00 --mail-user=$2 eval/zeroshot-sc_M.sh $1
# sbatch --gres=gpu:a6000:1 --partition=kilian -t 1-00:00:00 --mail-user=$2 eval/fewshot-sc_M.sh $1
# sbatch --gres=gpu:a6000:1 --partition=kilian -t 1-00:00:00 --mail-user=$2 eval/cot-sc_M.sh $1

sbatch --gres=gpu:a6000:8 --partition=kilian -t 1-00:00:00 --mail-user=$2 eval/zeroshot_L.sh $1
sbatch --gres=gpu:a6000:8 --partition=kilian -t 1-00:00:00 --mail-user=$2 eval/fewshot_L.sh $1
sbatch --gres=gpu:a6000:8 --partition=kilian -t 1-00:00:00 --mail-user=$2 eval/cot_L.sh $1
# sbatch --gres=gpu:a6000:8 --partition=kilian -t 1-00:00:00 --mail-user=$2 eval/zeroshot-sc_L.sh $1

#!/bin/bash
#SBATCH -J zeroshot-sc-medium                              # Job name
#SBATCH -o slurm/zeroshot-sc-medium_%j.out                 # output file (%j expands to jobID)
...
# if running on G2:
# sbatch --gres=gpu:a6000:2 --partition=kilian -t infinite eval/zeroshot-sc_M.sh <output directory>

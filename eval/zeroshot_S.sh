#!/bin/bash
#SBATCH -J zeroshot-small                              # Job name
#SBATCH -o slurm/zeroshot-small_%j.out                 # output file (%j expands to jobID)
#SBATCH -e slurm/zeroshot-small_%j.err                 # error log file (%j expands to jobID)

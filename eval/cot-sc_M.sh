#!/bin/bash
#SBATCH -J cot-sc-medium                              # Job name
#SBATCH -o slurm/cot-sc-medium_%j.out                 # output file (%j expands to jobID)
#SBATCH -e slurm/cot-sc-medium_%j.err                 # error log file (%j expands to jobID)
...
# if running on G2:
# sbatch --gres=gpu:a6000:2 --partition=kilian -t infinite eval/cot-sc_M.sh <output directory>

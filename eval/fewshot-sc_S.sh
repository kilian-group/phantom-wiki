#!/bin/bash
#SBATCH -J fewshot-sc-small                              # Job name
#SBATCH -o slurm/fewshot-sc-small_%j.out                 # output file (%j expands to jobID)
#SBATCH -e slurm/fewshot-sc-small_%j.err                 # error log file (%j expands to jobID)
...
# if running on G2:
# sbatch --gres=gpu:3090:1 --partition=kilian -t infinite eval/fewshot-sc_M.sh <output directory>

...
DEPTH_6_PATH = files("tests").joinpath("phantom_wiki/facts/templates_depth_6.json")
DEPTH_8_PATH = files("tests").joinpath("phantom_wiki/facts/templates_depth_8.json")
DEPTH_10_PATH = files("tests").joinpath("phantom_wiki/facts/templates_depth_10.json")

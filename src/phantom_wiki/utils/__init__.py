...
def get_parser(parents=[]):
    ...
    parser.add_argument("--use-multithreading", action="store_true", help="Use multithreading for querying the database when generating questions/answers. Note: This flag worked for windows and Linux, but not for MacOS. Also very intensive for high universe size.")

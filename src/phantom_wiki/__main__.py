...
def create_phantom_dataset(max_branching_factor=5, max_family_tree_depth=5, 
    ...
    Parameters
    ----------
    max_branching_factor : int, default=5
        The maximum number of children that any person in a family tree may have.
    max_family_tree_depth : int, default=5
        The maximum depth that a family tree may have.
    max_family_tree_size : int, default=26
        The maximum number of people that may appear in a family tree.
    num_samples : int, default=1
        The number of family trees to generate.
    stop_prob : float, default=0
    ...
    friendship_seed : int, default=1
        Seed for friendship generation.
    num_questions_per_type : int, default=10
    ...
    skip_solution_traces : bool, default=False
        Do not include solution traces in the dataset.
    debug : bool, default=False
        Enable debug output (DEBUG level).
    quiet : bool, default=False
        Enable quiet (no) output (WARNING level).
    visualize : bool, default=False
        Whether or not to visualize the friendship & family graphs.
    use_multithreading : bool, default=False
        Use multithreading for querying the database when generating questions/answers.
        Note: This flag works for Windows and Linux, but not for MacOS.
        Also very intensive for high universe size.
    seed : int, default=1
        Global seed for random number generator.
    output_dir : str, default="./out"
        Path to the output folder.
    article_format : str, default="txt"
        Format to save the generated articles. Options: 'txt', 'json'.
    question_format : str, default="json_by_type"
        Format to save the generated questions and answers. Options: 'json_by_type', 'json'.

    Returns
    -------
    None
        The function saves all generated data to the output directory as well as a
    ...
    save_command_and_git_info(output_dir)

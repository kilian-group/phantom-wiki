...
from phantom_eval._types import Conversation, Message, ContentTextMessage
...
medium_prompt = """
Given the following encyclopedia-style article, please rewrite it in a completely different structure and style while ensuring:
...
def transform_dataset(dataset, prompt, output_loc):
    """
...
def main():
    ...
    if not os.environ.get("TOGETHER_API_KEY"):
        raise EnvironmentError("TOGETHER_API_KEY environment variable must be set")

...
def get_prolog_results(responses: list[LLMChatResponse], db: Database, logger: logging.Logger, debug: bool = False) -> list[dict]:
    ...
    operate in a debug mode, which excecutes the sub-queries as separate queries, allowing for
